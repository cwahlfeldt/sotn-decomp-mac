...
s32 LoadFileSim(s32 fileId, SimFileType type) {
    ...
    case SimFileType_StagePrg:
        ...
        case STAGE_DRE:
            ...
            break;
        case STAGE_DAI:
            InitStageDAI(&g_api.o);
            break;
        case STAGE_NO2:
            InitStageNO2(&g_api.o);
            break;
        case STAGE_NO3:
            InitStageNO3(&g_api.o);
            break;
        case STAGE_NP3:
        ...
        case STAGE_RWRP:
            ...
            break;
        case STAGE_RNZ0:
            InitStageRNZ0(&g_api.o);
            break;
        case STAGE_CAT:
            InitStageCAT(&g_api.o);
            break;
        case STAGE_ARE:
            InitStageARE(&g_api.o);
            break;
        case STAGE_RCAT:
            InitStageRCAT(&g_api.o);
            break;
        case STAGE_NO4:
        ...
        case STAGE_NO0:
            ...
            break;
        case STAGE_LIB:
            InitStageLIB(&g_api.o);
            break;
        case STAGE_NO1:
            InitStageNO1(&g_api.o);
            break;
        case STAGE_RARE:
            InitStageRARE(&g_api.o);
            break;
        case STAGE_TOP:
            InitStageTOP(&g_api.o);
            break;
        case STAGE_NZ1:
            InitStageNZ1(&g_api.o);
            break;
        case STAGE_RTOP:
            InitStageRTOP(&g_api.o);
            break;
        case STAGE_NZ0:
